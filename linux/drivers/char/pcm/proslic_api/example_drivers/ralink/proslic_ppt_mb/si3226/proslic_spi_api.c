/*
** $Id: proslic_spi_api.c,v 1.1.1.1 2014/01/09 02:43:49 mt7620 Exp $
**
** spi.h
...
extern int SPI_bytes_write(int id, unsigned char ctrl, unsigned char cmd, unsigned char *data_ptr, unsigned char cmdLen);
extern int SPI_bytes_read(int id, unsigned char ctrl, unsigned char cmd, unsigned char *data_ptr, unsigned char cmdLen);
...
#if !(defined (CONFIG_RALINK_MT7621) || defined (CONFIG_RALINK_MT7628))	
	retVal = spi_si3226_read8(CONFIG_RALINK_PCM_SPICH, (unsigned char)(regCtrl), (unsigned char)regAddr);
#else	
	SPI_bytes_read(CONFIG_RALINK_PCM_SPICH-1, regCtrl, regAddr, &retVal, 1);
#endif	
	return retVal;
}
...
#else	
	SPI_bytes_write(CONFIG_RALINK_PCM_SPICH-1, regCtrl, regAddr, &data, 1);
#endif
}
...
#else	
	SPI_cfg(CONFIG_RALINK_PCM_SPICH-1);
#endif	
	i = 0;
	return (!i);
}
...
** Revision 1.1.1.1  2014/01/09 02:43:49  mt7620
**
**
