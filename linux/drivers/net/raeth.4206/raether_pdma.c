...
#else
				ei_local->tx_ring0[tx_cpu_owner_idx0].txd_info1.SDP0 = pci_map_page(NULL, frag->page.p, frag->page_offset, frag->size, PCI_DMA_TODEVICE);
#endif
...
#else
				ei_local->tx_ring0[tx_cpu_owner_idx0].txd_info3.SDP1 = pci_map_page(NULL, frag->page.p, frag->page_offset, frag->size, PCI_DMA_TODEVICE);
#endif
